...
bool LoopController::IsFinished(void) { return (state == finished); }
...
void LoopController::Initialize(XXDouble* u, XXDouble* y, XXDouble t) {
  ...
  /* set the parameters */
  m_P[0] = 20.0; /* PID_Left\Kp {} */
  m_P[1] = 2.0;    /* PID_Left\Kd {} */
  m_P[2] = 1.0;  /* PID_Left\Ki {} */
  m_P[3] = 20.0; /* PID_Right\Kp {} */
  m_P[4] = 2.0;    /* PID_Right\Kd {} */
...
void LoopController::Calculate(XXDouble* u, XXDouble* y /*, XXDouble t*/) {
  switch (state) {
    ...
    case mainrun: /* calculate the model */
      if ((m_time <= (m_finish_time - m_step_size + c_delta)) ||
          (m_finish_time == 0.0)) {
        /* another precessor submodel could determine the parameters of this
           submodel and therefore the static parameter calculations need to be
           performed. */
        CalculateStatic();
        CopyInputsToVariables(u);
        CalculateInput();
